  ...
  return new Promise(async (resolve, reject) => {
    ...
    if (uf) {
      uf.addEventListener("input", (e) => {
        ...
        let validate = isUfNaturalidade(value);
    ...
    if (email) {
      ...
      email.onblur = async () => {
        document.getElementById("msg-email").innerHTML =
          "<p style='color: black;'>Carregado...</p>";
    ...
    if (form) {
      form.addEventListener("submit", async (e) => {
        ...
        if (
          formDataAddress.cep &&
          formDataAddress.logradouro &&
          formDataAddress.numero &&
          formDataAddress.uf &&
          formDataAddress.bairro &&
          formDataAddress.cidade &&
          formDataAddress.telefone1 &&
          formDataAddress.telefone2 &&
